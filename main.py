...
def respond(voice_data):
    ...
    if there_exists(['tiffany']):
        engine_speak('tiffany is ty wife')

    if there_exists(['geek']):
        engine_speak('ty is a geek from new york')
    ...
    # Trouble
    if there_exists(["dice"]):
        voice_data = record_audio("Ready to roll, say roll")
        moves = ['1', '2', '3', '4', '5', '6', '1', '2', '3', '4', '5', '6', '1', '2', '3', '4', '5', '6']

        cmove = random.choice(moves)
        pmove = voice_data

        engine_speak("You rolled a" + cmove)

    # 10 stone paper scisorrs
    if there_exists(["game"]):
        voice_data = record_audio("choose among rock paper or scissor")
        moves = ["rock", "paper", "scissor","rock", "paper", "scissor","rock", "paper", "scissor"]
    ...
    if there_exists(["toss", "flip", "coin"]):
        moves = ["head", "tails", "head", "tails", "head", "tails"]
        cmove = random.choice(moves)
        engine_speak("The computer chose " + cmove)
    ...
    if there_exists(["exit", "quit", "goodbye", 'bye', 'see you later']):
